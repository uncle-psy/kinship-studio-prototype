...
const SAMPLE_ALIGNMENTS: Alignment[] = [
  {
    ...
    steps: [
      ...
      { id: "s5", type: "reflection", label: "Self-review", description: "Agent critiques output against vibes and domain accuracy" },
      { id: "s6", type: "action", label: "Draft post", description: "Write final post copy for each channel" },
    ],
    databases: [
...
const SAMPLE_GATHERINGS: Gathering[] = [
  {
    ...
    purpose: "Walk each new investor through NDA, accreditation, wallet connection, syndicate assignment, and document access",
    status: "active",
    participants: [
      { id: "p1", name: "DD Bot", role: "host", type: "agent" },
      { id: "p2", name: "Knowledge Agent", role: "participant", type: "agent" },
      { id: "p3", name: "Investor (dynamic)", role: "participant", type: "human" },
    ],
    vibeIds: ["growth-space"],
    approvalRules: [
      { id: "ar1", trigger: "Grant Tier 3 document access", threshold: "Always", approver: "Creator" },
      { id: "ar2", trigger: "Accept investment commitment", threshold: "Always", approver: "Creator" },
    ],
  ...
  },
  {
    ...
    purpose: "One-on-one coaching interaction with persistent memory across sessions, following the check-in/review/explore/commit chain",
    status: "active",
    participants: [
      { id: "p4", name: "Coaching Agent", role: "host", type: "agent" },
      { id: "p5", name: "Client Presence", role: "participant", type: "human" },
    ],
    vibeIds: ["gentle-guide"],
    approvalRules: [
      { id: "ar3", trigger: "Share session summary externally", threshold: "Always", approver: "Client" },
      { id: "ar4", trigger: "Distress or safety concern detected", threshold: "Any mention", approver: "Human Coach (escalation)" },
    ],
